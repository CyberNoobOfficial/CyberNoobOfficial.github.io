...
published: false
---
PowerShell as the name suggests is a pretty powerful language giving its users a lot of flexibility for writing scripts on Windows platforms. But that flexibility comes with a price **"The Syntax "**, it can be a bot confusing at first. This bold seris is all about simplfying some of the confusing parts of PowerShell.
